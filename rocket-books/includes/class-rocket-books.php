...
class Rocket_Books {
	...
	private function load_dependencies() {
		 ...
		 */
		//require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-rocket-books-post-types.php';
	...
	/**
	 * Define all actions and filter hooks for registering custom post types
	 */
